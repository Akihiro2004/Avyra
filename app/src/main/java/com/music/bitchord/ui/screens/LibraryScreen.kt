...
import com.music.bitchord.ui.components.LibraryRow
 ...
 * [LibraryRow][com.music.bitchord.ui.components.LibraryRow].
 *
...
private fun SectionLeading(item: ShelfItem, circular: Boolean) {
    when (item.browseId) {
        "local:downloads" -> LibraryIconTile(icon = BitChordIcons.Download)
