package com.avyra.music.widget
 ...
 * connecting one means starting [PlaybackService][com.avyra.music.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.avyra.music.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
         ...
         * process by
         * [AvyraApplication.onCreate][com.avyra.music.AvyraApplication],
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("avyra_widget", Context.MODE_PRIVATE)
