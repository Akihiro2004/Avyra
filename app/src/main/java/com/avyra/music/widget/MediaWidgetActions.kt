 ...
 * from [rememberMediaController][com.avyra.music.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.avyra.music.widget.TOGGLE"
        const val ACTION_NEXT = "com.avyra.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.avyra.music.widget.PREVIOUS"
