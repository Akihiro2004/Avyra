...
import com.avyra.music.data.settings.TransitionWindow
import com.avyra.music.playback.smart.CrossfadeMode
import com.avyra.music.playback.smart.TrackAnalysis
import com.avyra.music.playback.smart.TransitionStyle
import com.avyra.music.playback.smart.TransitionTrackInfo
import com.avyra.music.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.avyra.music.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.avyra.music.playback.smart.TransitionPlan],
     ...
     * ([com.avyra.music.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.avyra.music.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.avyra.music.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.avyra.music.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** Avyra doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
