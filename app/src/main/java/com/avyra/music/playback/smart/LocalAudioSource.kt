 ...
 * [com.avyra.music.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.avyra.music.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.avyra.music.playback.AudioCache.requestAnalysisHead] — the fallback
...
internal object LocalAudioSource {
    ...
    private const val TAG = "AvyraLocalAudio"
