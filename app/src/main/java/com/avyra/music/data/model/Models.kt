package com.avyra.music.data.model
...
data class Song(
     ...
     * that need it — see [com.avyra.music.playback.toMediaItem].
     */
...
data class DetailPage(
     ...
     * added — see [com.avyra.music.data.innertube.InnertubeParser.parsePlaylistShelf].
