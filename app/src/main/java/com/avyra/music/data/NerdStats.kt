...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.avyra.music.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun declaredFormat(mediaId: String?): StreamFormat? {
        ...
        return declared[key]
            ?: com.avyra.music.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.avyra.music.playback.PlaybackService] — which the
     ...
     *
     * @see com.avyra.music.playback.QualityUpgrade.forgetLastSession for the
