package com.avyra.music.data.sources.module
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use Avyra's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.avyra.music.data.sources.ModuleSource.search]
