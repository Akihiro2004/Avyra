...
import com.avyra.music.data.settings.DownloadQuality
...
object SourceResolver {
    ...
    /**
     * @param uri a `avyra://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.avyra.music.playback.toMediaItem].
     */
     ...
     * playback as `avyra://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.avyra.music.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.avyra.music.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.avyra.music.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.avyra.music.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.avyra.music.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.avyra.music.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.avyra.music.playback.QualityUpgrade]
     ...
     * [AudioCache][com.avyra.music.playback.AudioCache] decide how to treat
