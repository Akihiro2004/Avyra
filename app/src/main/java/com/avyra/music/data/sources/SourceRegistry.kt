...
object SourceRegistry {
    ...
    fun init(context: Context) {
        prefs = runCatching {
            LegacyDataMigration.encryptedPreferences(
                context = context,
                currentEncryptedName = "avyra_sources",
                legacyEncryptedName = "bitchord_sources",
                currentPlainName = "avyra_sources_plain",
                legacyPlainName = "bitchord_sources_plain",
            )
        }.getOrElse {
            ...
            LegacyDataMigration.plainPreferences(
                context = context,
                currentName = "avyra_sources_plain",
                legacyName = "bitchord_sources_plain",
            )
        }
     ...
     * see [SourcesScreen][com.avyra.music.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.avyra.music.data.model.Song.videoId]
