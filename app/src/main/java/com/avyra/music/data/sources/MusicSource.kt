...
data class StreamFormat(
    ...
    /** Dolby Atmos carried by an E-AC-3 JOC stream; immersive, but lossy. */
 ...
 * [StreamResolver][com.avyra.music.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.avyra.music.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.avyra.music.playback.QualityUpgrade.lookAgain].
 ...
 * [AppSettings][com.avyra.music.data.settings.AppSettings] and is turned
