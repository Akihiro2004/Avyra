...
private fun drawHeader(
    ...
    canvas.drawText("Avyra", POSTER_W - MARGIN, 132f, brand)
    ...
    val wordWidth = brand.measureText("Avyra")
...
/**
 * The Avyra mark, baseline-aligned with the word beside it.
 *
